...
@Controller
public class IncidentesTecnicoController {
	...
	/*
	 * @GetMapping("/listadoincidentestecnico") public ModelAndView
	 * ListadoIncidentesTecnico() {
	 * 
	 * ModelAndView mav = new ModelAndView("incidentesTecnico");
	 * mav.addObject("incidentesTecnico",
	 * incidentesService.ListAllIncidentesByTecnico()); return mav; }
	 */
	
	
	/*
	 * @GetMapping("/listadoincidentestecnico") public ModelAndView
	 * ListadoIncidentesTecnico(Tecnico tecnico) {
	 * 
	 * ModelAndView mav = new ModelAndView("incidentesTecnico");
	 * mav.addObject("incidentesTecnico",
	 * incidentesService.ListAllIncidentesByTecnico(tecnico)); return mav; }
	 */
